...
const Channels = require("../helpers/channels.js");

const CarbonCounter = function() {
  this.urlAllData = "http://localhost:3000/api/transportmodes";
  this.urlAlternativesData =
    "http://localhost:3000/api/alternativeTransportModes";
...
CarbonCounter.prototype.bindEvents = function() {
  PubSub.subscribe(Channels.form_request, evt => {
    this.getData();
  });
  ...
  PubSub.subscribe("FormView:TripDetails", evt => {
    ...
    PubSub.publish(
      "CarbonCounter:AlternativeTravelOptions",
...
CarbonCounter.prototype.calculateCO2e = function(
  co2e,
  distance,
  passengers = 1
) {
